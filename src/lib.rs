...
// (`sql-server-2025-master-msdb-sandbox-combined-catalog`, `sql-server-2025-master-msdb-sandbox-combined-catalog-populate-embeddings`, `sql-server-2025-master-msdb-sandbox-combined-catalog-healthcheck`)
...
// `sql-server-2025-master-msdb-sandbox-combined-catalog`'s own entry-point wiring, used by no other binary.
