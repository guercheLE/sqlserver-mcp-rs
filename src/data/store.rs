...
pub const VERSION_STORE_FILES: &[(&str, &str)] = &[
    ("2025", "mcp_store.db"),
    ("2022", "mcp_store_v2022.db"),
    ("2019", "mcp_store_v2019.db"),
    ("2017", "mcp_store_v2017.db"),
];

const VERSION_STORE_BYTES: &[(&str, &[u8])] = &[
    ("2025", include_bytes!("../../mcp_store.db")),
    ("2022", include_bytes!("../../mcp_store_v2022.db")),
    ("2019", include_bytes!("../../mcp_store_v2019.db")),
    ("2017", include_bytes!("../../mcp_store_v2017.db")),
];
// mcpify:versions:end
...
/// it, except `sql-server-2025-master-msdb-sandbox-combined-catalog-populate-embeddings` (a separate `[[bin]]`), which uses
...
/// `sql-server-2025-master-msdb-sandbox-combined-catalog-populate-embeddings` run, a deployment replacing the file) can update
