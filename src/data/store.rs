...
const VERSION_STORE_BYTES: &[(&str, &[u8])] = &[
    ...
    ("2019", include_bytes!("../../mcp_store_v2019.db.zst")),
    ("2017", include_bytes!("../../mcp_store_v2017.db.zst")),
];
// mcpify:versions:end
...
/// it, except `sqlserver-mcp-populate-embeddings` (a separate `[[bin]]`), which uses
...
/// `sqlserver-mcp-populate-embeddings` run, a deployment replacing the file) can update
